...
<head>
  ...
  <style>
  .rounded {
    border-radius: 15px; /* Adjust the value to change the amount of rounding */
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow rounded">
                    <span class="info-box-icon bg-red rounded-left-border"><i class="ion ion-ios-people-outline"></i></span>
                ...
                <div class="col-md-6">
                  <div class="info-box bg-c-yellow rounded">
                    <span class="info-box-icon bg-green rounded-left-border"><i class="ion ion-ios-browsers"></i></span>
                    <div class="info-box-content">
